...
/*
posto Stripe ne moze da prihvati tacke (dots) tipa 99.99, mi za cenu pisemo 9999 recimo i onda moramo da delimo sa 100 da bismo dobili human readable cenu */
const priceComputed = computed(() => {
	return product.value.price / 100
})

/*
kao popust od 20%, zapravo na cenu dodajemo 20% cele cene, tj price + 20% od price, 20% se dobija tako sto cenu DELIMO sa 20, i onda SVE TO delimo sa 100 zbog prikaza cene (Stripe issue) */
